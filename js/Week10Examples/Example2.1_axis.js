...
function setChart(csvData, colorScale){
    ...
    var bars = chart.selectAll(".bars")
        ...
        .attr("height", function(d){
            return parseFloat(d[expressed])? chartInnerHeight - yScale(parseFloat(d[expressed])):chartInnerHeight - yScale(parseFloat(0)); //deal with no value
        })
        .attr("y", function(d){
            return parseFloat(d[expressed])? yScale(parseFloat(d[expressed])) + topBottomPadding :  topBottomPadding;
        })
        .style("fill", function(d){
